...
from StudentCourseManagementSystem.models.instructor import Instructor, CourseAlreadyCreatedException
from StudentCourseManagementSystem.models.student import Student
from StudentCourseManagementSystem.managers.course_manager import CourseManager, RepeatedCourseCreationException
...
def view_course_grade(course_manager, grades=None):
    course_id = validate_id("Please enter course id")
    if course_manager.get_course(course_id):
